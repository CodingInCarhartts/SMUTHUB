    ...
    return (
        <view className="StateInspector">
            ...
            <view className="StateInspector-split">
                ...
                {selectedKey && (
                    <view className="StateInspector-detail-overlay" bindtap={() => setSelectedKey(null)}>
                        <view className="StateInspector-detail-modal" catchtap={() => { }}>
                            <view className="StateInspector-detail-header">
                                <text className="StateInspector-detail-title">{getKeyLabel(selectedKey)}</text>
                                <view className="StateInspector-btn danger small" bindtap={() => handleClearKey(selectedKey)}>
